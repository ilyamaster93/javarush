...
public class Solution {
    ...
    static
    {
        labels.put(5.0, "Лидия Аркадьевна Бубликова");
        labels.put(4.0, "Лидия Аркадьевна");
        labels.put(3.0, "Лидия Бубликова");
        labels.put(2.0, "Лидия");
        labels.put(1.0, "Аркадьевна Бубликова");
    }
